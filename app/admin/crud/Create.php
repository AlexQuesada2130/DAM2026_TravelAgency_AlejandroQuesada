...
<head>
    ...
    <style>
        body { background-color: #2388C7; min-height: 100vh; display: flex; justify-content: center; align-items: center; font-family: 'Segoe UI', sans-serif; }
        .dashboard-wrapper { background: white; padding: 40px; border-radius: 12px; max-width: 800px; width: 90%; }
    </style>
</head>
<body>
