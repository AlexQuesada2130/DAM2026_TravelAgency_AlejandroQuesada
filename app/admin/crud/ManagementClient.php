...
<head>
    ...
    <style>
        body { background-color: #2388C7; padding: 20px; font-family: 'Segoe UI', sans-serif; }
        ...
        .form-title { color: #563d7c; margin-top: 0; }
        
        /* Estilos Tabla */
        .table-responsive { overflow-x: auto; }
        .client-table { width: 100%; border-collapse: collapse; }
        .client-table th { background-color: #6f42c1; color: white; padding: 10px; text-align: left; }
        .client-table td { padding: 10px; border-bottom: 1px solid #eee; }
        
        /* Etiquetas de Rol */
        .badge { padding: 4px 8px; border-radius: 4px; font-size: 0.8em; font-weight: bold; }
        .badge-admin { background-color: #6f42c1; color: white; }
        .badge-user { background-color: #e9ecef; color: #333; }

        /* Botones Acción */
        .btn-purple { background-color: #6f42c1; color: white; border: none; cursor: pointer; width: 100%; margin-top: 10px; }
        .btn-purple:hover { background-color: #5a32a3; }
        
        /* Responsividad: En móviles una columna debajo de otra */
